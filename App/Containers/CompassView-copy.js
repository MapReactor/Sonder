...
class MapviewExample extends React.Component {
  ...
  *************************************************************/
  ...
  constructor (props) {
    ...
    *************************************************************/
    const region = calculateRegion([{ title: 'My Location', latitude: 37.785834, longitude: -122.406417, image: require('./../Images/friendmarker.png') }], { latPadding: 0.0075, longPadding: 0.0075 })
